...
import avatarImage from "@/shared/images/avatar.jpg";
...
function ThemeToggle() {
  ...
  const onThemeToogle = async () => {
    ...
    if (Pushy && Pushy.register && !isRegistered) {
      ...
      console.warn("Pushy SDK is not imported");
    }
